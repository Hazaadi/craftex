...
<body>
        ...
        <div id="myCarousel" class="carousel slide " data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active p-5 " data-interval="300">
                    <div class="overlay-image" style="background-image:url(images/pexels-harrisonhaines-3536487.jpg)">

                    </div>
                    <div class="contain p-5">
                        <h1>The African Lantern Blog</h1>
                        <a href="#blog" class="btn btn-lg btn-warning text-white">Blog Contents</a>
                    </div>
                </div>
                <!-- 2 -->
                <div class="carousel-item  p-5" data-interval="200">
                    <div class="overlay-image" style="background-image:url(images/blog.jpg)"></div>
                    <div class="contain p-5">
                        <h1>The African Lantern Blog</h1>
                        <a href="#blog" class="btn btn-lg btn-warning text-white">Blog Contents</a>
                    </div>
                ...
                <!-- 3 -->
                <div class="carousel-item  p-5" data-interval="200">
                    <div class="overlay-image" style="background-image:url(images/blog1.jpg)"></div>
                    <div class="contain p-5">
                        <h1>The African Lantern Blog</h1>
                        <a href="#blog" class="btn btn-lg btn-warning text-white">Blog Contents</a>
                    </div>
    ...
    <section id="blog" class="p-5  text-dark ">
        ...
        <div class="row align-items-center justify-content-between">
            ...
            <button class="btn fw-bold btn-success btn-lg" data-bs-toggle="modal" data-bs-target="#enroll"><i class="bi bi-chevron-down"></i> View our Blog</button><!-- Button trigger modal -->
            <!-- Pop up modal -->
                        ...
                        <div class="modal-body text-dark">
                            <div class=" col-md" style="background-color: black; ">
                                ...
                                <div class="contain text-white p-5">
                                    <h1>No Blog Content Yet. Stay Tuned
                                    </h1>
                    ...
                    <div class="card bg-dark text-light">
                        <div class="card-body text-md-start">
                            <div class=" mb-3"> <!-- In bootswtrap it is possible to use the h1 tag as a class -->
                                ...
                                <p class="mt-3">
                                    Email: info@eunoiainitiative.org
                                </p>
                            </div>
                        </div>
